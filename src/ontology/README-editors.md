These notes are for the EDITORS of simro
...
Make sure you have an ID range in the [idranges file](simro-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [simro-edit.owl](simro-edit.owl)

** DO NOT EDIT simro.obo OR simro.owl in the top level directory **

[../../simro.owl](../../simro.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/srobb1/simro) for details.
 ...
 * [simro-idranges.owl](simro-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/simro_terms.txt file
...
Note: the simro_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as simro.owl and simro.obo and places
 ...
 * https://github.com/srobb1/simro/releases
 * https://github.com/srobb1/simro/releases/new
...
what is in the `owl:versionIRI` of the derived simro.owl (`data-version` in
simro.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/simro.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/simro/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/srobb1/simro.svg?branch=master)](https://travis-ci.org/srobb1/simro)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/srobb1](https://travis-ci.org/profile/srobb1)
 2. click the "Sync account" button
 3. Click the tick symbol next to simro
