 ...
 * [simro.yml](simro.yml)
     * Determines how your purl.obolibrary.org/obo/simro/ redirects will be handled
     ...
     * Paste in the contents of [simro.yml](simro.yml)
 ...
 * [simro.md](simro.md)
     ...
     * Paste in the contents of [simro.md](simro.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
